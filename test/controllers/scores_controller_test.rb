...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { level_id: @score.level_id, user_id: @score.user_id, value: @score.value } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { level_id: @score.level_id, user_id: @score.user_id, value: @score.value } }
